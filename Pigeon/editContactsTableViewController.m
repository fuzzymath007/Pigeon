...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    PFUser *contact = self.foundContact;
    ...
    if ([self isContact:contact]) {
        ...
        for (PFUser *contact in self.contacts) {
            if ([contact.objectId isEqualToString:contact.objectId]) {
                [self.contacts removeObject:contact];
                break;
            }
        }
        
        [contactRelation removeObject:contact];
    } else {
        cell.accessoryType = UITableViewCellAccessoryCheckmark;
        [self.contacts addObject:contact];
        [contactRelation addObject:contact];
    }
